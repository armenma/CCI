...
In this directory, create [`crypto-currencies.js`](https://github.com/strongloop/loopback-example-angular/blob/master/client/js/controllers/crypto-currencies.js).
